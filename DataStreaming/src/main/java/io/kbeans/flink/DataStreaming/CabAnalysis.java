...
public class CabAnalysis {
	...
	DataSet<Tuple8<String, String, String, String, Boolean, String, String, Integer>> data = env.readTextFile("/home/jivesh/cab_flink.txt")
	...
	popularDest.writeAsText("/home/jivesh/popular_dest_batch.txt");
	...
	avgPassPerTrip.writeAsText("/home/jivesh/avg_passengers_per_trip.txt");
	...
	avgPassPerDriver.writeAsText("/home/jivesh/avg_passengers_per_driver.txt");
